...
function AddBorrowBook() {
    ...
    useEffect(() => {
      let result = usersAllD.filter(user => {
         ...
         let CNP = !searchUserCNP.length ? true : user.CNP.toLowerCase().includes(searchUserCNP.toLowerCase());
      ...
      searchUserFirstName, searchUserLastName, searchUserCNP
    ]);
                ...
                <div className="form-group">
                    <label htmlFor="subtitle">User: </label>
                     <img id="searchUser" src={searchIcon} alt="Search User" onClick={() => setShowSearchUser(!showSearchUser)}/> 
                      {showSearchUser && (
                        <>
                         <label className="searchcell_first"> First Name: <input type="text" value={searchUserFirstName} onChange={e => setSearchUserFirstName(e.target.value)} placeholder="search last user"/> </label>
                         <label className="searchcell_second"> Last Name: <input type="text" value={searchUserLastName} onChange={e => setSearchUserLastName(e.target.value)} placeholder="search first name"/> </label>
                        <label className="searchcell_second"> CNP: <input type="text" value={searchUserCNP} onChange={e => setSearchUserCNP(e.target.value)} placeholder="search CNP"/> </label>
